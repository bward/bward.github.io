...
\begin{center}
	\begin{tikzcd}
		\Gal(\mathbb{Q}_p(\zeta_{p^\infty}) / \mathbb{Q}_p) \ar{r}{\sim} & \varprojlim_n \Gal(\mathbb{Q}_p(\zeta_{p^n}) / \mathbb{Q}_p)  & (\sigma_m, \sigma_m(\zeta_{p^n}) = \zeta_{p^n}^m)\\
		\mathbb{Z}_p^\times \ar{r}{\sim}  \ar{u}{\Art_{\mathbb{Q}_p}|_{\mathbb{Z}_p^\times}} & \varprojlim_n (\mathbb{Z}/p^n\mathbb{Z})^\times \ar{u} & m \ar[maps to]{u}
	\end{tikzcd}
\end{center}
...
\begin{center}
	\begin{tikzcd}
		\mathbb{Q}_p^\times \ar[draw=none, sloped, xshift=-1ex]{d}{\cong} \ar{r}{\sim}[swap]{\Art_{\mathbb{Q}_p}} & W(\mathbb{Q}_p^{ab}/\mathbb{Q}_p) = W(\mathbb{Q}_p^{ur}\cdot\mathbb{Q}_p(\zeta_{p^\infty})/\mathbb{Q}_p) \ar{d}[rotate=90,anchor=center,yshift=1ex]{\sim} & \sigma \ar[maps to]{d} \\
		\langle p \rangle \times \mathbb{Z}_p^\times \ar{r}{\sim} & W(\mathbb{Q}_p^{ur}/\mathbb{Q}_p) \times \Gal(\mathbb{Q}_p(\zeta_{p^\infty})/\mathbb{Q}_p) & (\sigma|_{\mathbb{Q}_p^{ur}}, \sigma|_{\mathbb{Q}_p(\zeta_{p^\infty})}) \\
		\langle p^n, m \rangle \ar[maps to]{r} & (\Frob^n_{\mathbb{Q}_p}, \sigma_m)
	\end{tikzcd}
\end{center}
...
\begin{center}
	\begin{tikzcd}
		K^\times \ar{r}{\sim}[swap]{\Art_K} \ar[draw=none, sloped, xshift=-1ex]{d}{\cong} & W(K^{ab}/K)  \ar{d}[rotate=90,anchor=center,yshift=1ex]{\sim} & \sigma \ar[maps to]{d} \\
		\langle \pi \rangle \times U_K \ar{r}{\sim} & W(K^{ur}/K) \times \Gal(L_\infty/K) & (\sigma|_{K^{ur}}, \sigma|_{L^\infty}) \\
		(\pi^m, u) \ar[maps to]{r} & (\Frob_K^m, \sigma_u)
	\end{tikzcd}
\end{center}
...
\begin{lemma}
	...
	\begin{center}
		\begin{tikzcd}
			\Gal(L_m/K) \ar{r}{\sim}[swap]{127} \ar{d}[left]{\text{restriction}} & U_K/U_K^{(m)} \ar{d}{\text{quotient}} \\
			\Gal(L_n/K) \ar{r}{\sim}[swap]{127} & U_K/U_K^{(n)}
		\end{tikzcd}
	\end{center}
	\label{130}
\end{lemma}
