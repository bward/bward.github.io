...
Given a complex $C_\cdot$, we write
\begin{align*}
	Z_n(C_\cdot) &\rightarrowtail C_n \text{ for } \ker f_n \\
	B_n(C_\cdot) &\rightarrowtail C_n \text{ for } \img f_{n+1} \\
	Z_n(C_\cdot) &\rightarrowtail H_n(C_\cdot) \text{ for } \coker(B_n \rightarrowtail Z_n) \\
\end{align*}
If we also write $C_n \to Q_n(C_\cdot)$ for $\coker f_{n+1}$,
...
\begin{theorem}[Mayer-Vietoris]
	Let
	$$\begin{tikzcd}0 \ar{r} & C_\cdot \ar{r} & D_\cdot \ar{r} & E_\cdot  \ar{r} & 0\end{tikzcd}$$
	be a short exact sequence in $c\mathcal{A}$.
	Then there's an exact sequence
	$$\begin{tikzcd}[column sep=small]\dots \ar{r} & H_n(C_\cdot) \ar{r} & H_n(D_\cdot) \ar{r} & H_n(E_\cdot) \ar{r} & H_{n-1}(C_\cdot) \ar{r} & H_{n-1}(D_\cdot) \ar{r} & \dots\end{tikzcd}$$
\end{theorem}
\begin{proof}
	...
	\begin{center}
		\begin{tikzcd}
			& 0 \ar{d} & 0 \ar{d} & 0 \ar{d} \\
			0 \ar{r} & Z_n(C_\cdot) \ar{r} \ar{d} &  Z_n(D_\cdot) \ar{r} \ar{d} & Z_n(E_\cdot) \ar{d} \\
			0 \ar{r} & C_n \ar{r} \ar{d} &  D_n \ar{r} \ar{d} & E_n \ar{r} \ar{d} & 0 \\
			0 \ar{r} & C_{n-1} \ar{r} \ar{d} &  D_{n-1} \ar{r} \ar{d} & E_{n-1} \ar{r} \ar{d} & 0 \\
			& Q_{n-1}(C_\cdot) \ar{r} \ar{d} & Q_{n-1}(D_\cdot) \ar{r} \ar{d} & Q_{n-1}(E_\cdot) \ar{r} \ar{d} & 0 \\
			& 0 & 0 & 0
		\end{tikzcd}
	\end{center}
	...
	\begin{center}
		\begin{tikzcd}
			& 0 \ar{d} & 0 \ar{d} & 0 \ar{d} \\
			& H_n(C_\cdot) \ar{r} \ar{d} &  H_n(D_\cdot) \ar{r} \ar{d} & H_n(E_\cdot) \ar{d} \ar{llddd} \\
			& Q_n(C_\cdot) \ar{r} \ar{d} &  Q_n(D_\cdot) \ar{r} \ar{d} & Q_n(E_\cdot) \ar{r} \ar{d} & 0 \\
			0 \ar{r} & Z_{n-1}(C_\cdot) \ar{r} \ar{d} &  Z_{n-1}(D_\cdot) \ar{r} \ar{d} & Z_{n-1}(E_\cdot) \ar{d}\\
			& H_{n-1}(C_\cdot) \ar{r} \ar{d} & H_{n-1}(D_\cdot) \ar{r} \ar{d} & H_{n-1}(E_\cdot) \ar{d} \\
			& 0 & 0 & 0
		\end{tikzcd}
	\end{center}
\end{proof}
